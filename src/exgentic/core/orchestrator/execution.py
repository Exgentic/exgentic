...
def run_session_config(
    *,
    ...
    # benchmark.get_evaluator/get_session() — which spawn per-service
    # subprocesses — see session_id on the context and can write
    # per-service runtime.json at the correct path.
