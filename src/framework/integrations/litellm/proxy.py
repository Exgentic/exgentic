...
Usage (expects OPENAI_API_BASE/OPENAI_API_KEY already set for your backend):
    ...
    with LitellmProxy(model="openai/gpt-4o-mini") as proxy:
        ...
        # run your Codex/Framework flow that expects an OpenAI-compatible endpoint
...
TRACE_CALLBACK = "framework.integrations.litellm.trace_logger.trace_logger"
# TODO: see config.py — single callback is sufficient on litellm>=1.82.
# ASYNC_TRACE_CALLBACK = "framework.integrations.litellm.trace_logger.async_trace_logger"
...
class LitellmProxy:
    ...
    def _build_env(self) -> dict[str, str]:
        ...
        env["FRAMEWORK_PROXY_CACHE_INIT"] = "true"
