    ...
    if stats is None or StratifiedTable is None:
        try:
            ...
            raise click.ClickException(
                ...
                "Install them with `pip install 'framework[analysis]'`."
            ) from exc
...
def compare_cmd(
    ...
    Examples:
        ...
        framework compare --agent1 tool_calling  --model1 openai/gcp/gemini-3-pro-preview \\
                         --agent2 claude_code  --model1 openai/aws/claude-opus-4-5

        # Compare multiple agents (pairwise)
        framework compare --agent1 tool_calling --agent2 claude_code --agent3   openai_solo \\
                         --benchmark gsm8k

        # Compare multiple models
        framework compare --model1 openai/aws/claude-opus-4-5  --model2 openai/gcp/gemini-3-pro-preview  \\
                         --benchmark tau2/airline

        # Compare up to 5 different setups
        framework compare --agent1 tool_calling  --model1 openai/aws/claude-opus-4-5t \\
