...
BENCHMARKS: dict[str, RegistryEntry] = {
    "bfcl": RegistryEntry(
        slug_name="bfcl",
        display_name="BFCL",
        module="framework.benchmarks.bfcl.bfcl_benchmark",
        attr="BFCLBenchmark",
        kind="benchmark",
        subsets=(
            "simple_python",
    ...
    "tau2": RegistryEntry(
        ...
        module="framework.benchmarks.tau2.tau2_benchmark",
        attr="TAU2Benchmark",
        kind="benchmark",
    ...
    "appworld": RegistryEntry(
        ...
        module="framework.benchmarks.appworld.appworld_benchmark",
    ...
    "gsm8k": RegistryEntry(
        slug_name="gsm8k",
        display_name="GSM8k",
        module="framework.benchmarks.gsm8k.gsm8k_benchmark",
        attr="GSM8kBenchmark",
        kind="benchmark",
        subsets=("main",),
        subset_arg="subset",
    ...
    "hotpotqa": RegistryEntry(
        ...
        module="framework.benchmarks.hotpotqa.hotpotqa_benchmark",
    ...
    "browsecompplus": RegistryEntry(
        ...
        module="framework.benchmarks.browsecompplus.browsecomp_benchmark",
    ...
    "swebench": RegistryEntry(
        ...
        module="framework.benchmarks.swebench.swebench_benchmark",
...
AGENTS: dict[str, RegistryEntry] = {
    "tool_calling": RegistryEntry(
        ...
        module="framework.agents.litellm_tool_calling.litellm_tool_calling_agent",
    ...
    "smolagents_tool": RegistryEntry(
        ...
        module="framework.agents.smolagents.tool_calling_agent",
    ...
    "smolagents_code": RegistryEntry(
        ...
        module="framework.agents.smolagents.code_agent",
    ...
    "openai_solo": RegistryEntry(
        ...
        module="framework.agents.openai.openai_mcp_agent",
        attr="OpenAIMCPAgent",
        kind="agent",
    ),
    "claude_code": RegistryEntry(
        ...
        module="framework.agents.cli.claude.agent",
    ...
    "codex_cli": RegistryEntry(
        ...
        module="framework.agents.cli.codex.agent",
        attr="CodexAgent",
        kind="agent",
    ),
    "gemini_cli": RegistryEntry(
        ...
        module="framework.agents.cli.gemini.agent",
        attr="GeminiAgent",
        kind="agent",
    ),
}
