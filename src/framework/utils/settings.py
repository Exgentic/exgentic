...
DOTENV_PATH = Path(os.environ.get("FRAMEWORK_DOTENV_PATH", ".env"))
...
class FrameworkSettings(BaseSettings):
    ...
    def get_env(self) -> dict[str, str]:
        """Return env vars for all settings fields (FRAMEWORK_*)."""
        env: dict[str, str] = {}
...
def get_settings() -> FrameworkSettings:
    return FrameworkSettings()  # type: ignore[arg-type]
